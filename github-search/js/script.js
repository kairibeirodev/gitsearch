...
const enableNightMode = () => {
    ...
    if(isNightModeEnabled === true){
        ...
        document.documentElement.style.setProperty('--primary', ' #8103DB ')
        document.documentElement.style.setProperty('--main-backgroundcolor', '#8103DB ')
        document.documentElement.style.setProperty('--second-backgroundcolor', ' #8103DB ')
